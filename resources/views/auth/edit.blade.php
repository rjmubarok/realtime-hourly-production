        ...
        <div class="card card-info" style="">
            <form action="{{ route('user_update',$user->id ) }}"  method="post">
                ...
                <div class="card-header bg-cyan">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title text-bold mt-2">User Edit</h3>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="floor_id" id="floor_id">
                                    ...
                                    <option value="{{$floor->id}}" @if ($user->floor_id ==
                                        $floor->id) Selected @endif>{{$floor->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control customSelect2" name="line_id" id="line_id">
                                    <option selected>Select Line</option>
                                        ...
                                        <option value="{{$line->id}}" @if ($user->line_id ==
                                            $line->id) Selected @endif>{{$line->name}}</option>
                                        @endforeach
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control customSelect2" name="user_type" id="user_type" required>
                                    <option value="{{ $user->user_type }}" selected>{{$user->user_type ==2? 'User' : 'Floor Admin'}}</option>
