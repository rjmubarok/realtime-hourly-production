...
<table border="1" cellpadding="5" cellspacing="0">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="3" class="text-bold"> Target Achievement after 08 Hours Routine Duty:
            ...
            <td colspan="3" class="text-bold"> Target Achievement during 04 Hours OT:@if ($fourhour_ot > 0 && $sum_hourly_target > 0)
