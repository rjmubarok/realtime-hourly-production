     ...
     <table  class="table table-striped table-bordered table-sm">
         @if ($floor['lines']->count())
             ...
             <tbody>
                     ...
                     <tr>
                         ...
                         @if ($line['totals']['first'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['first'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['first'] }}</td>
                             @elseif(($line['totals']['first'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['first'] }}</td>
                             @elseif(($line['totals']['first'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['first'] }}</td>
                             @elseif(($line['totals']['first'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['first'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['first'] }}</td>
                         @endif
                         @if ($line['totals']['second'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['second'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['second'] }}</td>
                             @elseif(($line['totals']['second'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['second'] }}</td>
                             @elseif(($line['totals']['second'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['second'] }}</td>
                             @elseif(($line['totals']['second'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['second'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['second'] }}</td>
                         @endif
                         @if ($line['totals']['third'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['third'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['third'] }}</td>
                             @elseif(($line['totals']['third'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['third'] }}</td>
                             @elseif(($line['totals']['third'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['third'] }}</td>
                             @elseif(($line['totals']['third'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['third'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['third'] }}</td>
                         @endif
                         @if ($line['totals']['fourth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['fourth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['fourth'] }}</td>
                             @elseif(($line['totals']['fourth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['fourth'] }}</td>
                             @elseif(($line['totals']['fourth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['fourth'] }}</td>
                             @elseif(($line['totals']['fourth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['fourth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['fourth'] }}</td>
                         @endif
                         @if ($line['totals']['fifth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['fifth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['fifth'] }}</td>
                             @elseif(($line['totals']['fifth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['fifth'] }}</td>
                             @elseif(($line['totals']['fifth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['fifth'] }}</td>
                             @elseif(($line['totals']['fifth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['fifth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['fifth'] }}</td>
                         @endif
                         @if ($line['totals']['sixth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['sixth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['sixth'] }}</td>
                             @elseif(($line['totals']['sixth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['sixth'] }}</td>
                             @elseif(($line['totals']['sixth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['sixth'] }}</td>
                             @elseif(($line['totals']['sixth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['sixth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['sixth'] }}</td>
                         @endif
                         @if ($line['totals']['seventh'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['seventh'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['seventh'] }}</td>
                             @elseif(($line['totals']['seventh'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['seventh'] }}</td>
                             @elseif(($line['totals']['seventh'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['seventh'] }}</td>
                             @elseif(($line['totals']['seventh'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['seventh'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['seventh'] }}</td>
                         @endif
                         @if ($line['totals']['eighth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['eighth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['eighth'] }}</td>
                             @elseif(($line['totals']['eighth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['eighth'] }}</td>
                             @elseif(($line['totals']['eighth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['eighth'] }}</td>
                             @elseif(($line['totals']['eighth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['eighth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['eighth'] }}</td>
                         @endif
                         @if ($line['totals']['ninth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['ninth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['ninth'] }}</td>
                             @elseif(($line['totals']['ninth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['ninth'] }}</td>
                             @elseif(($line['totals']['ninth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['ninth'] }}</td>
                             @elseif(($line['totals']['ninth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['ninth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['ninth'] }}</td>
                         @endif
                         @if ($line['totals']['tenth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['tenth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['tenth'] }}</td>
                             @elseif(($line['totals']['tenth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['tenth'] }}</td>
                             @elseif(($line['totals']['tenth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['tenth'] }}</td>
                             @elseif(($line['totals']['tenth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['tenth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['tenth'] }}</td>
                         @endif
                         @if ($line['totals']['eleventh'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['eleventh'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['eleventh'] }}</td>
                             @elseif(($line['totals']['eleventh'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['eleventh'] }}</td>
                             @elseif(($line['totals']['eleventh'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['eleventh'] }}</td>
                             @elseif(($line['totals']['eleventh'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['eleventh'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['eleventh'] }}</td>
                         @endif
                         @if ($line['totals']['twelfth'] > 0 && $line['totals']['hourly_tar'] > 0)
                             @if (($line['totals']['twelfth'] / $line['totals']['hourly_tar']) * 100 <= 50)
                                 <td cope="col" style="background-color:red;">{{ $line['totals']['twelfth'] }}</td>
                             @elseif(($line['totals']['twelfth'] / $line['totals']['hourly_tar']) * 100 <= 99)
                                 <td cope="col" style="background-color:yellow;">{{ $line['totals']['twelfth'] }}</td>
                             @elseif(($line['totals']['twelfth'] / $line['totals']['hourly_tar']) * 100 == 100)
                                 <td cope="col" style="background-color:green;">{{ $line['totals']['twelfth'] }}</td>
                             @elseif(($line['totals']['twelfth'] / $line['totals']['hourly_tar']) * 100 >= 100)
                                 <td cope="col" style="background-color:blue;">{{ $line['totals']['twelfth'] }}</td>
                             @endif
                         @else
                             <td cope="col" style="background-color:red;">{{ $line['totals']['twelfth'] }}</td>
                         @endif
                 ...
                 <tr>
                 <td > Target Achievement of rang of Date:@if ($total_total > 0 && $total_sum_today_target > 0)
                         {{ number_format(($total_total / $total_sum_today_target) * 100, 2) }}%
                     @else
                         {{ number_format(0, 2) }}%
                     @endif
                 </td>
                 <td >Target Achievement in 1st Hour:@if ($total_first > 0 && $total_sum_hourly_target > 0)
                         {{ number_format(($total_first / $total_sum_hourly_target) * 100, 2) }}%
                     @else
                         {{ number_format(0, 2) }}%
                     @endif
                 </td>
                 <td >Target Achievement in 2nd Hour:@if ($total_second > 0 && $total_sum_hourly_target > 0)
                         {{ number_format(($total_second / $total_sum_hourly_target) * 100, 2) }}%
                     @else
                         {{ number_format(0, 2) }}%
                     @endif
                 </td>
                 <td > Target Achievement after 08 Hours Routine Duty:
                 ...
                 <td > Target Achievement during 04 Hours OT:@if ($total_fourhour_ot > 0 && $total_sum_hourly_target > 0)
