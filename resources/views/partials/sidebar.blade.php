    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <li class="nav-item">
                    <a href="{{ route('production_add') }}" class="nav-link">
                        <i class="nav-icon fas fa-circle"></i>
                        <p style="font-weight:bold;">
                            Hourly Production Add
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('production_show') }}" class="nav-link">
                        <i class="nav-icon fas fa-circle"></i>
                        <p style="font-weight:bold;">
                            Hourly Production Show
                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('previous_day') }}" class="nav-link">
                        <i class="nav-icon fas fa-circle"></i>
                        <p style="font-weight:bold;">
                            Previous Day Edit
                        </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('specific_date') }}" class="nav-link">
                        <i class="nav-icon fas fa-circle"></i>
                        <p style="font-weight:bold;">
                            Specific Date Edit
                        </p>
                ...
                <span style="display: inline-block; margin-top: 10px;">
                    <a href="{{ url('/target-page') }}" class="btn btn-success"
                        style="background-color: #fcfffd; border-radius: 25px; padding: 6px 15px; width: 100%; max-width: 300px; text-align: center;">
            ...
            @if (\Illuminate\Support\Facades\Auth::user()->user_type == 3)
                ...
                <li class="nav-item">
                    ...
                    <a href="http://192.168.6.166:8000/"
                        style="color: gray;  font-weight: bold; text-align: center;border:dotted;">🚀 What's Coming
                        Next ?? --</a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('generalReport') }}" class="nav-link">
