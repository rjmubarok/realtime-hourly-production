    ...
    <div class="row mb-2">
        <div class="col-sm-12">
            <div class="card card-info">
                <form action="{{ route('processUpdate', $single_data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header bg-cyan">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="card-title text-bold mt-2">Process Edit</h3>
                            </div>
                        </div>
                    </div>
