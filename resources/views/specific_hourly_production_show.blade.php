...
<head>
    ...
    <title>Hourly Production {{$date}}</title>
                                ...
                                @foreach ($productions as $production)
                                    <tr>
                                        ...
                                        <td cope="col"><input style="max-width:100px;"
                                                value="{{ $production->remark }}" type="text" name="remark[]">
                                        </td>
                                    </tr>
                ...
                <div class="col-md-12" style=" background-color: lightblue;">
                    <div class="card card-info" style=" background-color: lightblue;">
                        <div class="card-body text-center ">
                            <h3 class=" text-bold mt-2"> Hourly Production Show Edit Update</h3>
                            <input type="hidden" name="floor_id" value="{{ $floor->id }}">
                            <h3 class=" text-bold mt-2">Floor: {{ $floor->name ?? '' }}</h3>
                            <h3 class=" text-bold mt-2">Date:{{ \Carbon\Carbon::parse($date)->format('l, d F Y') }}</h3>
